...
#ifndef TURTLEBOT3_LIME_HARDWARE__OPENCR_DEFINITIONS_HPP_
#define TURTLEBOT3_LIME_HARDWARE__OPENCR_DEFINITIONS_HPP_
...
namespace wheels {
constexpr double SEPERATION = 0.29425;
constexpr double RADIUS = 0.06;

// ref) http://emanual.robotis.com/docs/en/dxl/x/xl430-w250/#goal-velocity104
constexpr double RPM_TO_MS = 0.229 * (2.0 * M_PI) / 60.0;
...
constexpr uint8_t JOINT5 = 4;
constexpr uint8_t JOINT6 = 5;
...
#endif  // TURTLEBOT3_LIME_HARDWARE__OPENCR_DEFINITIONS_HPP_
