...
def generate_launch_description():
    ...
    ompl_planning_yaml = load_yaml(
        "turtlebot3_manipulation_moveit_config", "config/ompl_planning.yaml"
    )
    ...
    # RViz
    rviz_base = os.path.join(get_package_share_directory("turtlebot3_manipulation_moveit_config"), "config")
